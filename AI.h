/*
In my freshman year of college, I got a team together to work throughout the semester to create a C++ project. We chose to create the popular "Battleship" game.
My contribution to the project was creating a computer AI for a player to compete against. The code for the AI is below.
*/
